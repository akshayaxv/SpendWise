...
* Frontend: [Netlify](https://SpendWise.netlify.app/)
* Backend: [Render](https://SpendWise.onrender.com)
...
We'd like to extend our heartfelt thanks to everyone who has contributed to **SpendWise** — whether through code, design, documentation, bug reports, or ideas. Your efforts make this project better for everyone. 💖
